...
public class Task {
    ...
    //я это добавил для переопределения конструктора в Эпике public Epic(String[] lineContents),
    // т.к. он там инициализируется без времени старта, можно было бы добавить ещё параметр в сигнатуру для перегрузки,
    // но решил, что это костыль, а пустой конструктор в Таске - не криминал, но если лучше с перегрузкой - то переделаю.
    public Task() {
    }
